...
declare module "rxjs/operators" {
  declare module.exports: {
    ...
    concatMap<+T, U>(
      f: (value: T) => rxjs$ObservableInput<U>
    ): (rxjs$Observable<T>) => rxjs$Observable<U>,
...
declare module "rxjs" {
  declare module.exports: {
    concat<+T>(...sources: rxjs$Observable<T>[]): rxjs$Observable<T>,
    forkJoin<+T>(...sources: rxjs$Observable<T>[]): rxjs$Observable<T>,
    from<+T>(
      input: rxjs$ObservableInput<T>,
      scheduler?: rxjs$SchedulerClass
    ): rxjs$Observable<T>,
    of<+T>(...values: T[]): rxjs$Observable<T>,
    zip<+T>(...values: T[]): rxjs$Observable<T>,
    combineLatest<+T>(...values: T[]): rxjs$Observable<T>,
